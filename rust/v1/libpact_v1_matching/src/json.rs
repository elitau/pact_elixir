...
fn compare(path: Vec<&str>, expected: &Json, actual: &Json, config: &DiffConfig, mismatches: &mut Vec<super::Mismatch>) {
    match (expected, actual) {
        ...
        (_, _) => compare_values(path, expected, actual, config, mismatches)
    }
}
...
fn compare_values(path: Vec<&str>, expected: &Json, actual: &Json, config: &DiffConfig, mismatches: &mut Vec<super::Mismatch>) {
    if expected != actual {
        mismatches.push(Mismatch::BodyMismatch { path: path.join("."),
            expected: Some(value_of(expected)),
            actual: Some(value_of(actual)),
...
mod tests {
    ...
    fn match_json_handles_comparing_strings() {
        ...
        expect!(mismatch_message(&mismatch)).to(be_equal_to(s!("Type mismatch: Expected \"string value\" but received \"other value\"")));
    }
    ...
    fn match_json_handles_comparing_integers() {
        ...
        expect!(&mismatch).to(be_equal_to(&Mismatch::BodyMismatch { path: s!("$.body"), expected: Some(val1),
            actual: Some(val2), mismatch: s!("")}));
        expect!(mismatch_message(&mismatch)).to(be_equal_to(s!("Type mismatch: Expected 100 but received 200")));
    }
    ...
    fn match_json_handles_comparing_floats() {
        ...
        expect!(&mismatch).to(be_equal_to(&Mismatch::BodyMismatch { path: s!("$.body"), expected: Some(val1),
            actual: Some(val2), mismatch: s!("")}));
        expect!(mismatch_message(&mismatch)).to(be_equal_to(s!("Type mismatch: Expected 100.01 but received 100.02")));
    }
    ...
    fn match_json_handles_comparing_booleans() {
        ...
        expect!(&mismatch).to(be_equal_to(&Mismatch::BodyMismatch { path: s!("$.body"), expected: Some(val1),
            actual: Some(val2), mismatch: s!("")}));
        expect!(mismatch_message(&mismatch)).to(be_equal_to(s!("Type mismatch: Expected true but received false")));
    }
    ...
    fn match_json_handles_comparing_nulls() {
        ...
        expect!(&mismatch).to(be_equal_to(&Mismatch::BodyMismatch { path: s!("$.body"), expected: Some(val1),
            actual: Some(val2), mismatch: s!("")}));
        expect!(mismatch_message(&mismatch)).to(be_equal_to(s!("Type mismatch: Expected null but received 33")));
    }
