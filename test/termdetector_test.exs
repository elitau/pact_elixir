defmodule PactElixir.TermDetectorTest do
  ...
  test "detect and convert empty Term in map to desired format" do
    output = PactElixir.TermDetector.recursively_update_terms(%{field_1: "hey", field_2: "ho", field_3: %Term{}})
    assert output == %{
      field_1: "hey",
      field_2: "ho",
      field_3: %{
  ...
  test "detect and convert Term in nested map to desired format" do
    output = PactElixir.TermDetector.recursively_update_terms(%{
      field_1: "hey",
      field_2: "ho",
      field_3: %Term{regex: "someawesomeregex",
        generate:
          %Term{generate:
            %Term{generate: "1", regex: "somegreatregex"},
        regex: "somecoolregex"}},
      field_4: "zzz"})
